        ...
        <div className="register-form-container">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="social-buttons">
              <button type="button" className="social-btn github" onClick={() => window.location.href = 'http://localhost:8081/oauth2/authorization/github'}>
                <FaGithub /> Continue with GitHub
              </button>
              <button type="button" className="social-btn google" onClick={() => window.location.href = 'http://localhost:8081/oauth2/authorization/google'}>
